...
def solution(n, build_frame):
	...
	for frame in build_frame:
		x,y,struct,operation=frame

		if operation==0:	#삭제
			answer.remove([x,y,struct])	#삭제 후 가능한 구조인지 확인
			if not check(answer,n):
				answer.append([x,y,struct])	#가능하지 않으면 다시 설치
		elif operation==1:	#설치
